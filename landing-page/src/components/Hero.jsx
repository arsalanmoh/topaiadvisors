...
export function Hero() {
  return (
    <Container className="pb-8 pt-20 text-center lg:pt-32">
      ...
      <h1 class="mx-auto max-w-4xl font-display font-medium tracking-tight text-slate-900 text-2xl md:text-4xl lg:text-4xl">

        {/* <div className="mb-12 relative rounded-full px-3 py-1 text-base leading-6 text-indigo-900 ring-1 ring-gray-900/10 hover:ring-gray-900/20">
          ✨ News: We welcome former Princeton and Berkeley AI research scientists and Google&apos;s technical leads to our team. ✨
        </div> */}
        ...
        <span className="relative whitespace-nowrap text-indigo-600">
          ...
          <span className="relative"> Ideation to Production </span>
        </span>{' '}
      </h1>
      ...
      <div className="mt-24 lg:mt-29">
        <p className="font-display text-base text-slate-900">
          With a commitment that every project is supervised by an AI technical lead from
        </p>
        <ul
          role="list"
